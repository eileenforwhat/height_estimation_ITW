...
if __name__ == '__main__':
    img_path = 'data/mountain'
    selected_imgfiles=['mountain1.jpeg', 'mountain2.jpeg']
    # outputs
    corresp_path = 'data/mountain/corresp.npy'
    viz_match_path = 'data/mountain/viz_matches.jpg'
    peaks_path = 'data/mountain/peak_coords.npy'
    ...
    inliers1, inliers2 = pts1, pts2
    show_viz(images[0], images[1], inliers1, inliers2, F, title="mountain")
    ...
    # inliers1 = from_homogeneous(inliers1.T).T
    # inliers2 = from_homogeneous(inliers2.T).T
    inliers_3d = triangulate(P1, P2, inliers1.T, inliers2.T).T  # (N, 4)
